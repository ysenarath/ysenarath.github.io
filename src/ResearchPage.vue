<template>
    <div class="app">
        <header-section v-bind:activeItem="'Research'"></header-section>
        <div class="container page-container">
            <div class="row row-cols-1" v-for="(item, index) in publications">
                <div class="col mb-3">
                    <div class="card h-100">
                        <div class="card-body">
                            <h5 class="card-title">{{ item.title }}</h5>
                            <p class="card-text">{{ item.copyrightYear }} {{ item.publication }}</p>
                            <p>{{ item.author }}</p>
                            <article-modal v-bind:data="item" v-bind:index="index"></article-modal>
                            <button
                                    type="button"
                                    class="btn btn-light"
                                    data-toggle="modal"
                                    v-bind:data-target="'#article_' + index"
                            > Abstract
                            </button>
                        </div>
                    </div>
            ...
            return {
                publications: [
                    ...
                    },
                    {
                        ...
                        copyrightYear: 2019,
                        author:
                            "Senarath, Yasas and Jihan, Nadheesh and Ranathunga, Surangika",
                        url: "#",
                        abstract:
                    ...
                    },
                    {
                        ...
                        publication: "Moratuwa Engineering Research Conference (MERCon)",
                        copyrightYear: 2019,
                        author:
                            "Jenarthanan, Rajenthiran and Senarath, Yasas and Thayasivam, Uthayasanker",
                        url: "#",
                        abstract:
                    ...
                    {
                        title:
                            "Multiple Word Embedding based Models for Implicit Emotion Classification of Tweets with Deep Learning",
                        publication:
                            "9th Workshop on Computational Approaches to Subjectivity, Sentiment and Social Media Analysis (WASSA)",
                        copyrightYear: 2018,
                    ...
                    },
                    {
                        ...
                        publication:
                            "18th International Conference on Advances in ICT for Emerging Regions (ICTer)",
                        copyrightYear: 2018,
                        author:
                            "Jihan, Nadheesh and Senarath, Yasas and Ranathunga, Surangika",
                        url: "#",
                        abstract:
                    ...
                    },
                    {
                        ...
                        publication:
                            "29th Conference on Computational Linguistics and Speech Processing (ROCLING)",
                        copyrightYear: 2017,
                        author:
                            "Jihan, Nadheesh and Senarath, Yasas and Tennekoon, Dulanjaya and Wickramarathne, Mithila and Ranathunga, Surangika",
                        url: "#",
                        abstract:
                            "This paper describes a system to extract aspect categories for the task of aspect based sentiment analysis. This system can extract both implicit and explicit aspects. We propose a one-vs-rest Support Vector Machine (SVM) classifier preceded by a state of the art preprocessing pipeline. We present the use of mean embeddings as a feature along with two other new features to significantly improve the accuracy of the SVM classifier. This solution is extensible to customer reviews in different domains. Our results outperform the best recorded F1 score in the SemEval-2016 Task 5 dataset consisting of customer reviews from restaurant and laptop domains."
                    }
                ]
            };
        }
